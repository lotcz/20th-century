...
export const PANEL_MARGIN = new Vector2(15, 15);
...
export default class PanelVisitorRenderer extends DomRenderer {
	...
	renderInternal() {
		const rangeEnd = this.game.viewBoxSize.subtract(this.model.size.add(PANEL_MARGIN));
		const rangeStart = rangeEnd.add(PANEL_MARGIN).multiply(0.5);
