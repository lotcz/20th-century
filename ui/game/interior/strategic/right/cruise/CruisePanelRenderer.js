	...
	activateInternal() {
		...
		this.addChild(
			new PanelVisitorRenderer(
				this.game,
				this.model.strategic.cruisePanel,
				this.wrapper
			)
		);
		...
		this.addChild(
			new MenuRenderer(
				this.game,
				this.model.strategic.cruisePanel.cruiseAltitudeMenu,
		...
		this.addChild(
			new MenuRenderer(
				this.game,
				this.model.strategic.cruisePanel.cruiseExploreMenu,
		...
		this.addChild(
			new MenuRenderer(
				this.game,
				this.model.strategic.cruisePanel.cruiseCityMenu,
		...
		this.addChild(
			new MenuRenderer(
				this.game,
				this.model.strategic.cruisePanel.toggleScannerMenu,
				DOMHelper.createElement(this.panelBottom, 'div', 'city')
			)
		);
