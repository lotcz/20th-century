...
export default class WorldConstants {
	...
	static UFO_MEDIUM_ALTITUDE = WorldConstants.ATMOSPHERE_RADIUS + 4;
	static UFO_MAX_ALTITUDE = WorldConstants.ATMOSPHERE_RADIUS + 10;
	...
	static ATMOSPHERE_VISIBLE_RADIUS = WorldConstants.EARTH_RADIUS + 3;
	static CLOSE_DISTANT_THRESHOLD_RADIUS = WorldConstants.EARTH_RADIUS * 4;
	static MIN_DISTANCE_RADIUS = WorldConstants.EARTH_RADIUS + 2;
	...
	static PANEL_SIDE_SIZE = new Vector2(150, 450);
	static PANEL_DETAIL_SIZE = new Vector2(450, 450);
